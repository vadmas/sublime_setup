...
config = {
    ...
    "default_value": {
        "smtp_login": "vadmas@gmail.com",
        "smtp_passwd": "HalinaPohorelic123",
        "from": "vadmas@gmail.com",
        "display_name": u"Vaden Masrani",
        "recipients": "",
        "subject": u"Code"
    },
...
class GmailCommand(sublime_plugin.TextCommand):
    ...
    def send_email(self):
        ...
        try:
            ...
            message = "There was an error sending the email to: %s . Error: %s" % (recipients, str(e))
            print(message)
